...
// MAGIC 
// MAGIC ## This is a simple notebook for Understanding ADB capabilities
...
al configs = Map(
  ...
  "fs.azure.account.oauth2.client.id" -> "b868f356-ea97-4aa6-99a9-d97609054ac2",
  "fs.azure.account.oauth2.client.secret" -> dbutils.secrets.get(scope = "AMSTrainingScope", key = "appsecret"),
...
// COMMAND ----------
  ...
  dbutils.fs.mount(
  source = "abfss://data@amsstorageaccsource.dfs.core.windows.net/",
  mountPoint = "/mnt/data",
...
spark.udf.register("toSentiment", toSentiment)import java.io._
import java.net._
import java.util._
